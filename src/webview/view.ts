...
export interface ViewElements {
  ...
  windowFunctionHelp: HTMLElement;
  ...
  amplitudeScaleMode: HTMLSelectElement;
  amplitudeScaleHelp: HTMLElement;
  ...
  selectionAnalysisPane: HTMLElement;
  selectionAnalysisClose: HTMLButtonElement;
...
export function renderShell(root: HTMLDivElement): ViewElements {
  ...
  return {
    ...
    windowFunctionHelp: query("#windowFunctionHelp", HTMLElement),
    ...
    amplitudeScaleMode: query("#amplitudeScaleMode", HTMLSelectElement),
    amplitudeScaleHelp: query("#amplitudeScaleHelp", HTMLElement),
    ...
    selectionAnalysisPane: query("#selectionAnalysisPane", HTMLElement),
    selectionAnalysisClose: query("#selectionAnalysisClose", HTMLButtonElement),
...
function decorateSettingHelp(root: ParentNode): void {
  root.querySelectorAll<HTMLElement>("[data-setting-help]").forEach((container) => {
    const key = container.dataset.settingHelp as keyof LocaleMessages | undefined;
    const label = container.querySelector<HTMLElement>("span[data-i18n]");
    if (!key || !label) {
      return;
    }
    const labelRow = document.createElement("span");
    labelRow.className = "settingLabel";
    label.before(labelRow);
    labelRow.append(label);
    const help = document.createElement("span");
    help.className = "settingHelp";
    help.tabIndex = 0;
    help.textContent = "?";
    help.dataset.i18nTooltip = key;
    help.dataset.i18nAria = label.dataset.i18n;
    help.setAttribute("aria-label", label.textContent || "Parameter help");
