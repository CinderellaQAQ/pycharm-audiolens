...
export const messages = {
  ...
  windowSizeHelp: "Samples analyzed in each FFT frame. Larger values improve frequency detail but reduce time detail and require more computation.",
  ...
  windowRectangularHelp: "Rectangular window: keeps every sample unchanged. It has a narrow main lobe but relatively strong spectral leakage unless the frame is periodic.",
  windowBartlettHelp: "Bartlett window: a triangular taper that reduces edge discontinuities and leakage compared with a rectangular window.",
  windowHammingHelp: "Hamming window: smoothly attenuates both frame edges and offers a practical leakage/resolution balance commonly used for speech analysis.",
  windowHannHelp: "Hann window: tapers both edges to zero and provides reliable general-purpose spectral leakage suppression.",
  windowBlackmanHelp: "Blackman window: lowers side lobes further, making weak components easier to see at the cost of a wider main lobe.",
  windowBlackmanHarrisHelp: "Blackman-Harris window: provides very strong side-lobe suppression and high dynamic range, with lower frequency resolution.",
  windowWelchHelp: "Welch window: uses a parabolic taper and balances main-lobe width with leakage suppression.",
  windowGaussian25Help: "Gaussian window α=2.5: a moderate smooth taper that balances time and frequency concentration.",
  windowGaussian35Help: "Gaussian window α=3.5: stronger edge attenuation than α=2.5, reducing boundary effects further.",
  windowGaussian45Help: "Gaussian window α=4.5: the strongest Gaussian taper here; it lowers side lobes but shortens the effective time span.",
  zeroPaddingFactor: "Zero padding factor",
  zeroPaddingFactorHelp: "Appends zeros before the FFT to sample the spectrum on a denser frequency grid. It smooths interpolation but does not add true frequency resolution.",
  frequencyScale: "Frequency scale",
  frequencyScaleHelp: "Controls vertical spacing: linear uses equal Hz intervals; log, Mel, Bark, and ERB emphasize perceptually important low-frequency detail.",
  frequencyRange: "Frequency range (display only)",
  minFrequencyHz: "Min frequency (Hz)",
  minFrequencyHzHelp: "Lowest frequency displayed in the spectrogram. Frequencies below it are hidden, not removed from the audio.",
  maxFrequencyHz: "Max frequency (Hz)",
  maxFrequencyHzHelp: "Highest frequency displayed. It cannot exceed the Nyquist frequency, which is half the sample rate.",
  maxFrequencyNyquist: "Max follows Nyquist",
  maxFrequencyNyquistHelp: "Automatically sets the upper display limit to half the current sample rate so the full measurable band remains visible.",
  spectrogramAppearance: "Spectrogram appearance",
  palette: "Palette",
  paletteHelp: "Maps spectrogram energy to colors. It changes only visualization, not the FFT values or audio.",
  paletteRose: "Rose",
  paletteClassic: "Classic",
  paletteGrayscale: "Grayscale",
  paletteInverseGrayscale: "Inverse grayscale",
  minDb: "Min dB (brightness)",
  minDbHelp: "Spectrogram energy at or below this dB level uses the darkest palette color. Lower values reveal weaker components and noise.",
  maxDb: "Max dB (brightness)",
  maxDbHelp: "Spectrogram energy at or above this dB level uses the brightest palette color. It controls contrast, not playback volume.",
  autoBrightness: "Auto brightness",
  autoBrightnessHelp: "Estimates suitable minimum and maximum spectrogram dB levels from the current audio. Manual dB edits disable it.",
  amplitudeRange: "Amplitude range (waveform)",
  amplitudeScale: "Amplitude scale",
  amplitudeScaleAdaptive: "Adaptive",
  amplitudeScaleSample: "Sample values",
  amplitudeScaleDecibel: "Decibels (dBFS)",
  amplitudeScaleAdaptiveHelp: "Adaptive scale: fits each channel to its measured peak on a linear sample-value axis so quiet waveforms remain visible.",
  amplitudeScaleSampleHelp: "Sample-value scale: shows source PCM values, such as -32768 to 32767 for signed 16-bit audio. Floating-point or compressed decoder output remains -1 to +1. Custom limits can be entered below.",
  amplitudeScaleDecibelHelp: "dBFS scale: uses a symmetric logarithmic waveform axis. 0 dBFS is digital full scale and levels below -60 dBFS meet at the center floor.",
  minAmplitude: "Min amplitude",
  minAmplitudeHelp: "Lower source-sample limit of the waveform axis. It is used only in Sample values mode.",
  maxAmplitude: "Max amplitude",
  maxAmplitudeHelp: "Upper source-sample limit of the waveform axis. It is used only in Sample values mode.",
  ...
  sampleRateHelp: "How many samples per second the PCM data contains. A wrong value changes playback speed and all time/frequency measurements.",
  channels: "Channels",
  channelsHelp: "How many interleaved audio channels the PCM data contains, such as 1 for mono or 2 for stereo.",
  startOffsetBytes: "Offset (B)",
  startOffsetBytesHelp: "Number of leading bytes to skip before PCM samples begin. Use it when a raw stream has a custom header.",
  bitDepth: "Encoding",
  bitDepthHelp: "How each PCM sample is stored: signed/unsigned integer or floating point, together with its bit depth.",
  sampleFormat: "Format",
  endianness: "Byte order",
  endiannessHelp: "Byte order for multi-byte PCM samples. Little-endian stores the least significant byte first; big-endian stores it last.",
  read: "Read",
  saveDefault: "Save default",
  cancel: "Cancel",
  defaultView: "Default view",
  view: "View",
  viewHelp: "Chooses the initial content of each channel track: waveform, spectrogram, or both. Individual tracks can still be changed later.",
  viewBoth: "Multi-view",
  mute: "Mute",
  solo: "Solo",
  timeLabel: "Time",
  ...
  closeSelectionAnalysis: "Close selection analysis",
